function LeagueEditModal({ league, onSave, onClose }) {
  try {
      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Editar Liga</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-gray-700 mb-2 font-semibold">Nombre de la Liga</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-gray-700 mb-2 font-semibold">Logo de la Liga</label>
              <input
                type="file"
                accept="image/*"
              ...
              />
              <p className="text-sm text-gray-500 mt-1">O ingresa una URL:</p>
              <input
                type="url"
                value={logoUrl}
    ...
    console.error('LeagueEditModal error:', error);
    return null;
  }
}